    ...
    <tr>
        <td class="mainTd">
            <form action="register.php" method="post">
                <p>First Name: <input type="text" name="FirstName" size="15" maxlength="20"
                                      value="<?php if (isset($_POST['FirstName'])) echo $_POST['FirstName']; ?>"/></p>

                <p>Last Name: <input type="text" name="LastName" size="15" maxlength="40"
                ...
                <p>Company: <input type="text" name="Company" size="15" maxlength="40"
