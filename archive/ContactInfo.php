...
<tr>
<td id="address2" colspan=1>
Alternate Street Address (Optional): 
</td>
<td>
<input type ="text" name="A_Street" size=50%/> <br />
</td>
</tr>
<tr>
<td id="city2" colspan=1>
City: 
</td>
<td>
...
<td id="state2" class="fld alignRight">State <span ></span></td>
<td colspan=3>
<select name="state" size="1" class="med">
		<option value="??">Select a U.S. State</option>
		<option value="">Outside the U.S.</option>
...
<tr>
<td id="zip code2" colspan=1>
Zip Code: 
</td>
<td>
<input type ="text" name="A_ZIP"/> <br />
</td>
</tr>
<tr>
...
<tr>
<td id="phone2" colspan=1>
Alternate Phone Number:  
</td>
<td>
<input type ="text" name="A_Phone"/> <br />
</td>
</tr>
<tr>
...
<FORM METHOD="LINK" ACTION="addLakeHost.php">
