...
(function () {
    var f = function (b, a) {
        ...
        b.$control.on("click", "button", function () {
            var a, e = null;
            a = Number(jQuery(this).attr("data-number")) || 0;
            e = f(b, !1);
            e.data.currentPage = a;
            b.history.addStatus(e);
            b.observer.trigger(b.observer.events.statusChanged, [e])
        })
    }, d = function (b) {
        b.params = {view: new jQuery.fn.jplist.ui.controls.PaginationView(b.$control, b.controlOptions)};
        g(b);
...
(function () {
    ...
    jQuery.fn.jplist.controlTypes.pagination = {
        className: "Pagination", options: {
            range: 7, jumpToStart: !1, prevArrow: "&lsaquo;",
            nextArrow: "&rsaquo;", firstArrow: "&laquo;", lastArrow: "&raquo;"
        }
    }
})();
(function () {
    jQuery.fn.jplist.ui.controls.PaginationDTO = function (f, g) {
        var d = {currentPage: f, paging: null};
        g && (d.number = g);
        return d
    }
})();
