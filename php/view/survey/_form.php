<form>
    ...
    <div class="radio">
        ...
        <input type='radio' id="radio2" name='boat' value='PWC/jet ski/jet boat'/><label for="radio2">PWC/jet ski/jet
            boat</label>
        ...
        <div>
            ...
            <input type='radio' name='drained' value='1'/> YES <input type='radio' name='drained' value='0'/> NO
            <br/><br/>

            <label>Rinsed?</label><br/>
            <input type='radio' name='rinsed' value='1'/> YES <input type='radio' name='rinsed' value='0'/> NO
            <br/><br/>

            <label>Dry for at least 5 days?</label><br/>
            <input type='radio' name='dryForFiveDays' value='1'/> YES <input type='radio' name='dryForFiveDays'
                                                                             value='0'/> NO <br/><br/>
