...
<div id="waterbody-form">
    ...
    if (!isset($waterbody))
        ...
        <input type="text" name="waterbody[name]"
               class="medium" <?php if (isset($waterbody)) echo "value='" . $waterbody['name'] . "'"; ?>><br/><br/>

        <!-- Waterbody Type -->
        <label for="waterbodyType">Type</label><br/>
        <?php echo $this->selectList($types, array("required" => "true", "name" => "waterbody[waterType]", "id" => "waterbody", "class" => "medium selectmenu"), $type); ?>
        <br/><br/>
